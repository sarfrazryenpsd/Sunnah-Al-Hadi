...
fun ColorScheme.extraContentColors(type: ExtraContentType): ExtraContentColor {
    ...
    return when (type) {
        ExtraContentType.PARABLE -> ExtraContentColor(
            iconColor = if(isDark)Color(0xFFEF9797) else Color(0xFF8B1F1F),
        ...
        ExtraContentType.SCHOLARLY_EXPLANATION -> ExtraContentColor(
            iconColor = if(isDark)Color(0xFF89F192) else Color(0xFF1B5E20),
        ...
        ExtraContentType.EXPLANATION -> ExtraContentColor(
            iconColor = if(isDark)Color(0xFF92FCFF) else Color(0xFF006064),
        ...
        ExtraContentType.TRANSLATION -> ExtraContentColor(
            iconColor = if(isDark)Color(0xFFB19BFF) else Color(0xFF4527A0),
        ...
        ExtraContentType.HADITH -> ExtraContentColor(
            iconColor = if(isDark)Color(0xFFFAC4B2) else Color(0xFF8D6E63),
        ...
        ExtraContentType.WARNING -> ExtraContentColor(
            iconColor = if(isDark)Color(0xFFFF7070) else Color(0xFFC62828),
        ...
        ExtraContentType.BENEFIT -> ExtraContentColor(
            iconColor = if(isDark)Color(0xFFFDC08F) else Color(0xFFF57F17),
